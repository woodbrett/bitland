...
def getUtxo (transaction_hash = '', vout = 0, id = 0):
    ...
    query = ("select planet_id, st_astext(geom) as shape, pub_key, id, vout, transaction_hash, transaction_id, block_id, miner_fee_sats, miner_fee_blocks, transfer_fee_sats, transfer_fee_blocks, transfer_fee_address, bitcoin_block_height, miner_bitcoin_address, miner_landbase_address, output_version, transfer_fee_failover_address, claim_fee_sats, claim_block_height, miner_fee_status, transfer_fee_status, claim_status, claim_on_parcel " +
             "from bitland.utxo " +
    ...
    try:
        ...
        utxo_output = {
            ...
            'claim_status': output_parcel[22], 
            'claim_on_parcel': output_parcel[23]
        }
